...
func (t *volumeIOTestSuite) skipUnsupportedTest(pattern testpatterns.TestPattern, driver testdriver.TestDriver) {
}
...
func (t *volumeIOTestSuite) execTest(driver testdriver.TestDriver, pattern testpatterns.TestPattern) {
