...
//             Master string
//     }
//     _ = config.AddOptions(&scaling, "storage.csi")
//
...
//              a boolean
//
// The name of the final configuration options are a combination of an
...
//
// Therefore the command line flags for the example above will be:
//
//     -storage.csi.scaling.numNodes=<int>
...
func AddOptions(options interface{}, prefix string) bool {
	...
	structType := optionsType.Elem()
	structValue := reflect.Indirect(reflect.ValueOf(options))
